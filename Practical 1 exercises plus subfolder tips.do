...
**** Additional notes on navigating within subfolders - Melissa Neuman, 25/9/25

* Set working directory (WD)
cd "C:\Users\eidemneu\OneDrive - London School of Hygiene and Tropical Medicine\Intro Statistical Computing\Stata teaching 2025"

* cd "H:\Stats Computing\Stata\Data\Exercise 1"

* Move from WD into "Exercise 1" subfolder within WD
cd ".\Exercise 1"

* Move back up into WD 
cd .. 

* Look at files within within "Stata Datasets" subfolder in WD
dir ".\Stata Datasets\"

* Use file bl_demog, saved within "Stata Datasets" subfolder in WD
use "Stata Datasets\bl_demog"
clear


capture log close // this closes any log files that are already open
...
* Ex 1.2
* Data Drop-down Menu
* use "H:\Stats Computing\Stata\Data\bl_demog.dta", clear
use "Stata Datasets\bl_demog"
describe
describe using "Stata Datasets\vitals_long"
